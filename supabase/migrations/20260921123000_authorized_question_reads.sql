-- Phase 2 authorized normalized-question reads + RPC hardening.
-- These functions expose only metadata for questions the caller is entitled
-- to access; normalized tables themselves remain server-only/RLS locked.
