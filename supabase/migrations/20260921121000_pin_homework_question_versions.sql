-- Phase 2: pin homework items to the latest immutable question version.
-- Existing legacy assignments remain readable with a nullable version id.
...
begin
  ...
  loop
    ...
    values (
      ...
      item ->> 'question_id',
      public.resolve_latest_question_version_id(
        item ->> 'practice_set_id',
        item ->> 'question_id'
      ),
