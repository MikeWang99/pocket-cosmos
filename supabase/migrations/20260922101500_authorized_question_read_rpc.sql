-- Phase 2 authorized normalized-question reads.
-- Keep normalized question tables private; expose only entitlement-checked
-- SECURITY DEFINER RPCs to signed-in users.
...
-- Harden Phase 2/legacy SECURITY DEFINER functions against anonymous RPC use.
