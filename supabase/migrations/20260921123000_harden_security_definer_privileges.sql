-- Harden SECURITY DEFINER execution privileges after Phase 2 rollout.
...
-- Trigger-only helper: API callers should never execute it directly.
...
-- Keep the assignment timestamp trigger on a fixed search_path.
