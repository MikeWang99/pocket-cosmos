-- Authorized normalized question reads.
-- These RPCs expose immutable question metadata only after checking the
-- authenticated user's entitlement or assignment visibility.
