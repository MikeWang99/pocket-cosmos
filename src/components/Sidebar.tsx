        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className="group relative flex min-h-14 flex-col items-center justify-center gap-1 rounded-xl px-2 text-[11px] font-semibold text-slate-500 md:min-h-0 md:w-full md:rounded-2xl md:px-2 md:py-3"
              title={item.label}
            >
              {isActive && (
                <motion.div
