    ...
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between mb-10">
        ...
        <div className="grid grid-cols-3 gap-3 min-w-[280px]">
          ...
          >
            ...
            <div className="text-[10px] uppercase tracking-widest text-slate-500">Reset</div>
          </button>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-[260px_minmax(0,1fr)] gap-6">
        <aside className="glass-panel rounded-lg p-3 h-fit">
          <div className="px-3 py-2 text-[10px] uppercase tracking-widest text-slate-500">Question Path</div>
            ...
            {practiceSteps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[10px] mt-1 opacity-60">{result ? `${result.score}/${result.maxScore} pts` : `${step.maxScore} pts`}</div>
                </button>
              );
            })}
          </div>
        ...
        <section className="space-y-6">
              ...
              <div className="border-b border-white/10 p-6 md:p-8">
                ...
                <div className="mt-6 grid md:grid-cols-[1fr_1.2fr] gap-4">
                  <div className="rounded-lg bg-black/20 border border-white/5 p-4">
                    <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-2">Setup</div>
                  ...
                  <div className="rounded-lg bg-white/[0.04] border border-white/10 p-4">
                    <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-2">Your Task</div>
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center justify-between gap-4 mb-3">
                  ...
                  <button
                    ...
                    title={speechSupported ? 'Dictate response' : 'Speech input is not available in this browser'}
                  >
                ...
                <textarea
                  ...
                  placeholder="Write or dictate your reasoning here. Include the principle, equations, and conclusion you would want a grader to see."
                />

                <div className="mt-3 rounded-lg border border-white/5 bg-black/20 p-4 text-sm text-slate-400">
                  <span className="text-slate-200">Hint:</span> {activeStep.answerNudge}
                </div>
          ...
          {currentResult && (
            ...
            >
              <div className="glass-panel rounded-lg p-6">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Rubric Score</div>
              ...
              <div className="glass-panel rounded-lg p-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {currentResult.hits.length ? (
                        ...
                        <div className="text-sm text-slate-500">No rubric points detected yet.</div>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {currentResult.misses.length ? (
                        ...
                        <div className="text-sm text-emerald-300">All rubric points detected.</div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                {currentResult.suggestions.length > 0 && (
                  <div className="mt-6 border-t border-white/10 pt-5">
                    <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Revision Advice</div>
          ...
          <div className="glass-panel rounded-lg p-6">
            ...
            {weakSpots.length > 0 && (
              <div className="mt-6 border-t border-white/10 pt-5">
                <div className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Patterns To Review</div>
                <div className="flex flex-wrap gap-2">
                  {weakSpots.map((spot) => (
