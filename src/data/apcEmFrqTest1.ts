...
**(C)** Determine the electric field at the center of the square.`,
    ['Coulomb\u2019s law', 'superposition', 'equilibrium', 'symmetry'],
    {
      ...
      sampleAnswer: '(A) $q = Q / (2\sqrt{2})$. Set the diagonal repulsion from the other $+Q$ equal to the vector sum of attractions from the two $-q$ charges. (B) No. Substituting $q = Q/(2\sqrt{2})$ shows the net force on $-q$ is not zero because the force magnitudes do not balance. (C) $E = 0$ at the center by symmetry: $E_1 = E_2$ and $E_3 = E_4$, so all components cancel.',
      assets: [
        { id: 'em-frq1-q1-ans1', kind: 'source', src: img('Page_543_Image_0004.jpg'), alt: 'Q1 answer diagram: force balance', downloadName: 'em-frq1-q1-answer-1.png' },
        { id: 'em-frq1-q1-ans2', kind: 'source', src: img('Page_544_Image_0001.jpg'), alt: 'Q1(A) derivation', downloadName: 'em-frq1-q1-answer-2.png' },
        { id: 'em-frq1-q1-ans3', kind: 'source', src: img('Page_544_Image_0002.jpg'), alt: 'Q1(B) force on -q', downloadName: 'em-frq1-q1-answer-3.png' },
        { id: 'em-frq1-q1-ans4', kind: 'source', src: img('Page_544_Image_0006.jpg'), alt: 'Q1(C) E=0 at center', downloadName: 'em-frq1-q1-answer-4.png' },
      ],
    },
  ),
  frq(
...
**(E)** If a small negative charge, $-q$, of mass $m$ were placed at the origin, determine its initial acceleration (magnitude and direction).`,
    ['Coulomb\u2019s law', 'electric field', 'superposition', 'zero-field point', 'acceleration'],
    {
      ...
      sampleAnswer: '(A) $F = kQ(2Q)/(3a)^2 = 2kQ^2/(9a^2)$, directed in $+y$ (away from Charge 2). (B) $E_1 = kQ/a^2$ (downward), $E_2 = k(2Q)/(2a)^2 = kQ/(2a^2)$ (upward). Net: $E = kQ/a^2 - kQ/(2a^2) = kQ/(2a^2)$, directed downward ($-y$). (C) No. The only point on the x-axis where fields point in opposite directions is the origin, but $E \neq 0$ there. (D) Yes. A point P exists between the charges on the y-axis where fields cancel: $y = a(2\sqrt{2}-3)$. (E) $a = qE/m = qkQ/(2ma^2)$, directed in $+y$ (upward, since charge is negative and field is downward).',
      assets: [
        { id: 'em-frq1-q2-ans1', kind: 'source', src: img('Page_545_Image_0001.jpg'), alt: 'Q2(A) force magnitude', downloadName: 'em-frq1-q2-answer-1.png' },
        { id: 'em-frq1-q2-ans2', kind: 'source', src: img('Page_545_Image_0002.jpg'), alt: 'Q2(A) force vector', downloadName: 'em-frq1-q2-answer-2.png' },
        { id: 'em-frq1-q2-ans3', kind: 'source', src: img('Page_545_Image_0003.jpg'), alt: 'Q2(B) field vectors', downloadName: 'em-frq1-q2-answer-3.png' },
        { id: 'em-frq1-q2-ans4', kind: 'source', src: img('Page_545_Image_0004.jpg'), alt: 'Q2(B) net field', downloadName: 'em-frq1-q2-answer-4.png' },
        { id: 'em-frq1-q2-ans5', kind: 'source', src: img('Page_546_Image_0001.jpg'), alt: 'Q2(D) zero-field point', downloadName: 'em-frq1-q2-answer-5.png' },
        { id: 'em-frq1-q2-ans6', kind: 'source', src: img('Page_546_Image_0005.jpg'), alt: 'Q2(E) acceleration', downloadName: 'em-frq1-q2-answer-6.png' },
      ],
    },
  ),
  frq(
...
**(B)** Show in the figure the charges that reside on or inside each of the two shells.`,
    ['Gauss\u2019s law', 'conductors', 'spherical symmetry', 'charge distribution'],
    {
      ...
      sampleAnswer: '(A)(i) $r < a$: $E = 0$ (no charge enclosed). (ii) $a < r < b$: $E = 0$ (inside conductor). (iii) $b < r < c$: $E = 2kq/r^2$ (enclosed charge $+2q$). (iv) $c < r < d$: $E = 0$ (inside conductor). (v) $r > d$: $E = 5kq/r^2$ (enclosed charge $+2q + 3q = +5q$). (B) Inner shell: $+2q$ on outer surface (radius $b$). Outer shell: $-2q$ on inner surface (radius $c$), $+5q$ on outer surface (radius $d$).',
      assets: [
        { id: 'em-frq1-q3-ans1', kind: 'source', src: img('Page_547_Image_0001.jpg'), alt: 'Q3 charge distribution diagram', downloadName: 'em-frq1-q3-answer-1.png' },
        { id: 'em-frq1-q3-ans2', kind: 'source', src: img('Page_547_Image_0002.jpg'), alt: 'Q3(A)(iii) E field', downloadName: 'em-frq1-q3-answer-2.png' },
        { id: 'em-frq1-q3-ans3', kind: 'source', src: img('Page_547_Image_0003.jpg'), alt: 'Q3(A)(v) E field outside', downloadName: 'em-frq1-q3-answer-3.png' },
      ],
    },
  ),
  frq(
...
$$\\int \\frac{dx}{(x^2 + a^2)^{3/2}} = \\frac{x}{a^2\\sqrt{x^2+a^2}}$$`,
    ['Gauss\u2019s law', 'continuous charge distribution', 'linear charge density', 'integration'],
    {
      ...
      sampleAnswer: '(A) For $x_1 \ll \ell$, the rod appears infinitely long. Using a cylindrical Gaussian surface: $E(2\pi x_1 L) = \lambda L / \varepsilon_0$, so $E = \lambda / (2\pi\varepsilon_0 x_1)$, directed radially outward ($+x$). (B) $Q = \lambda\ell$. (C) By symmetry, vertical components cancel. Integrating horizontal components: $E = \frac{2k\lambda}{x_2}\frac{\ell/2}{\sqrt{x_2^2 + (\ell/2)^2}}$. For $x_2 = \ell$: $E = \frac{2kQ}{\ell^2\sqrt{5}}$.',
      assets: [
        { id: 'em-frq1-q4-formula', kind: 'source', src: img('Page_343_Image_0002.jpg'), alt: 'Integration formula hint', downloadName: 'em-frq1-q4-formula.png' },
        { id: 'em-frq1-q4-ans1', kind: 'source', src: img('Page_548_Image_0001.jpg'), alt: 'Q4(A) Gaussian surface', downloadName: 'em-frq1-q4-answer-1.png' },
        { id: 'em-frq1-q4-ans2', kind: 'source', src: img('Page_548_Image_0002.jpg'), alt: 'Q4(A) Gauss law result', downloadName: 'em-frq1-q4-answer-2.png' },
        { id: 'em-frq1-q4-ans3', kind: 'source', src: img('Page_548_Image_0003.jpg'), alt: 'Q4(A) final E expression', downloadName: 'em-frq1-q4-answer-3.png' },
        { id: 'em-frq1-q4-ans4', kind: 'source', src: img('Page_549_Image_0001.jpg'), alt: 'Q4(C) integration setup', downloadName: 'em-frq1-q4-answer-4.png' },
        { id: 'em-frq1-q4-ans5', kind: 'source', src: img('Page_549_Image_0002.jpg'), alt: 'Q4(C) result for x2=l', downloadName: 'em-frq1-q4-answer-5.png' },
      ],
    },
  ),
  frq(
...
**(D)** Sketch the electric field magnitude $E$ as a function of $r$ on the graph below. Be sure to indicate on the vertical axis the value of $E$ at $r = a$.`,
    ['Gauss\u2019s law', 'volume charge density', 'spherical symmetry', 'E-field sketch'],
    {
      ...
      sampleAnswer: '(A) $[\rho_s] = \mathrm{C/m^3}$ (same as volume charge density, since $r/a$ is dimensionless). (B) $Q = \int_0^a \rho_s(r/a) \cdot 4\pi r^2 dr = \pi\rho_s a^3$. (C)(i) For $r < a$: $Q_{\text{enc}} = \pi\rho_s r^4/a$, so $E = \rho_s r^2 / (4\varepsilon_0 a) = Qr^2/(4\pi\varepsilon_0 a^4)$. (ii) For $r \geq a$: $Q_{\text{enc}} = Q$, so $E = Q/(4\pi\varepsilon_0 r^2)$. (D) $E$ increases as $r^2$ from 0 to $a$, then decreases as $1/r^2$ for $r > a$. Peak value at $r = a$: $E = Q/(4\pi\varepsilon_0 a^2)$.',
      assets: [
        { id: 'em-frq1-q5-ans1', kind: 'source', src: img('Page_549_Image_0003.jpg'), alt: 'Q5(B) charge integration', downloadName: 'em-frq1-q5-answer-1.png' },
        { id: 'em-frq1-q5-ans2', kind: 'source', src: img('Page_549_Image_0004.jpg'), alt: 'Q5(B) total charge Q', downloadName: 'em-frq1-q5-answer-2.png' },
        { id: 'em-frq1-q5-ans3', kind: 'source', src: img('Page_549_Image_0005.jpg'), alt: 'Q5(C)(i) enclosed charge', downloadName: 'em-frq1-q5-answer-3.png' },
        { id: 'em-frq1-q5-ans4', kind: 'source', src: img('Page_550_Image_0001.jpg'), alt: 'Q5(C)(i) E inside', downloadName: 'em-frq1-q5-answer-4.png' },
        { id: 'em-frq1-q5-ans5', kind: 'source', src: img('Page_550_Image_0002.jpg'), alt: 'Q5(C)(i) Gauss law', downloadName: 'em-frq1-q5-answer-5.png' },
        { id: 'em-frq1-q5-ans6', kind: 'source', src: img('Page_550_Image_0003.jpg'), alt: 'Q5(C)(ii) E outside', downloadName: 'em-frq1-q5-answer-6.png' },
        { id: 'em-frq1-q5-ans7', kind: 'source', src: img('Page_550_Image_0004.jpg'), alt: 'Q5(D) E vs r sketch', downloadName: 'em-frq1-q5-answer-7.png' },
      ],
    },
  ),
];
