  ...
  units: [
    unit(1, 'Motion, Forces and Energy', '运动、力与能量', 'Core + Supplement', [
      ...
      formulas: [
        ...
        formula('Impulse', '冲量', 'F\\Delta t=\\Delta(mv)'),
        formula('Force from momentum change', '由动量变化求合力', 'F=\\frac{\\Delta p}{\\Delta t}'),
        formula('Kinetic energy', '动能', 'E_k=\\frac12mv^2'),
        formula('Change in gravitational potential energy', '重力势能变化', '\\Delta E_p=mg\\Delta h'),
        formula('Work', '功', 'W=Fd=\\Delta E'),
        formula('Energy efficiency', '能量效率', '\\eta=\\frac{E_{\\mathrm{useful}}}{E_{\\mathrm{input}}}\\times100\\%'),
        formula('Power', '功率', 'P=\\frac{W}{t}=\\frac{\\Delta E}{t}'),
        formula('Pressure', '压强', 'p=\\frac{F}{A}'),
        formula('Liquid pressure change', '液体压强变化', '\\Delta p=\\rho g\\Delta h'),
      ],
      diagrams: [
        ...diagrams.kinematics,
        ...diagrams.dynamics,
