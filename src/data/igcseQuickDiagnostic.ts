...
export const igcseQuickDiagnosticSteps: PracticeStep[] = [
  ...
  // ─── Q14–Q25: Extended MCQ from topic banks (Forces / Momentum / Energy) ───
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q14 · Newton\u2019s Second Law with Friction',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.5 Forces',
    tags: ['Forces', 'Difficulty 4'],
    image: {
    ...
    maxScore: 1,
    source: 'CIE IGCSE Physics 0625 · 1.5 Forces',
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q15 · Resultant of Three Forces',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.5 Forces',
    tags: ['Forces', 'Difficulty 4'],
    image: {
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q16 · Moments in Simple Machines',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.5 Forces',
    tags: ['Forces', 'Difficulty 4'],
    image: {
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q17 · Circular Motion Force Direction',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.5 Forces',
    tags: ['Forces', 'Difficulty 4'],
    image: {
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 3,
    title: 'Q18 · Collision Speed Calculation',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.6 Momentum',
    tags: ['Momentum', 'Difficulty 3'],
    image: {
    ...
    maxScore: 1,
    source: 'CIE IGCSE Physics 0625 · 1.6 Momentum',
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 3,
    title: 'Q19 · Inelastic Collision (Equal Masses)',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.6 Momentum',
    tags: ['Momentum', 'Difficulty 3'],
    image: {
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q20 · Impulse and Average Force',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.6 Momentum',
    tags: ['Momentum', 'Difficulty 4'],
    image: {
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q21 · Head-On Inelastic Collision',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.6 Momentum',
    tags: ['Momentum', 'Difficulty 4'],
    image: {
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q22 · Braking Force from Kinetic Energy',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.7 Energy, Work and Power',
    tags: ['Energy', 'Difficulty 4'],
    image: {
    ...
    maxScore: 1,
    source: 'CIE IGCSE Physics 0625 · 1.7 Energy, Work and Power',
  ...
  },
  {
    ...
    mode: 'multiple_choice',
    difficulty: 4,
    title: 'Q25 · Potential Energy to Speed',
    prompt: 'Select the correct option using the question shown in the image.',
    context: 'CIE IGCSE Physics · 1.7 Energy, Work and Power',
    tags: ['Energy', 'Difficulty 4'],
    image: {
...
export const igcseQuickDiagnosticMeta = {
  ...
  subtitle: '25 MCQ · forces, momentum, energy & more · with solutions',
