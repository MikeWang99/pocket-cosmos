...
export const igcseQuickDiagnosticSteps: PracticeStep[] = [
  ...
  },
  {
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.6/q20.webp',
      alt: 'Ball hits the floor at 10 m/s and rebounds at 8 m/s — find the average force during the collision',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Change in momentum = m × (final velocity − initial velocity). Watch the directions!',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'Taking upward as positive: Δp = m(v − u) = 0.50 × (8 − (−10)) = 0.50 × 18 = 9.0 kg·m/s. F = Δp/t = 9.0 / 0.50 = 18 N, directed upwards.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q22',
  ...
  },
  {
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.5/q99.webp',
      alt: 'Four vector diagrams — which one correctly shows the resultant of forces P and Q',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Use the parallelogram rule: the resultant starts from the common origin of the two forces.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'By the parallelogram rule, the resultant of P and Q is the diagonal starting from their common origin. Only diagram C shows this correctly; the others show Q − P or the wrong direction.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q24',
  ...
  },
  {
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.7/q85.webp',
      alt: 'Box slides down a slope of length l against friction F, descending height d — GPE loss and work done against friction',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'GPE change uses the vertical height; work done uses the distance moved along the slope.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'A',
    solution: 'Loss in GPE = mg × vertical height = mgd. Work done against friction = friction × distance along the slope = Fl.',
    criteria: [],
  },
];
