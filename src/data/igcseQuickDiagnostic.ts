...
export const igcseQuickDiagnosticSteps: PracticeStep[] = [
  ...
  // ─── Q16–Q25: Motion graphs, core concepts (acceleration / force), measurement ───
  {
    id: 'igcse-diag-q16',
    mode: 'multiple_choice',
    difficulty: 4,
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q51.webp',
      alt: 'Block falls from an aeroplane into the sea and sinks — choose the correct speed–time graph',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Think about each stage: falling through air, hitting the water, then sinking.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'The block accelerates in air (speed rises, curve flattens as drag grows), drops sharply at the water surface (large deceleration but speed does not reach zero), then sinks at a lower constant terminal speed in water.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q17',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q56.webp',
      alt: 'Speed–time graph for a car — find the acceleration between 6.0 s and 10.0 s',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Acceleration = gradient of the speed–time graph over that interval.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'a = Δv/Δt = (15.0 − 10.0) / (10.0 − 6.0) = 5.0 / 4.0 = 1.25 m/s².',
    criteria: [],
  },
  {
    id: 'igcse-diag-q18',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q58.webp',
      alt: 'Curved speed–time graph — at which labelled time is the acceleration greatest',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Acceleration is the gradient of the tangent — where is the curve steepest?',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'B',
    solution: 'Acceleration = gradient of the speed–time graph. The tangent is steepest at B, so the acceleration is greatest there. Near D the curve is flattening out (small acceleration).',
    criteria: [],
  },
  {
    id: 'igcse-diag-q19',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q59.webp',
      alt: 'Four distance–time graphs — which object is decelerating',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'On a distance–time graph, the gradient represents speed. Decelerating = gradient getting smaller.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'Graph C has a gradient that decreases with time (curve flattens) — speed is decreasing, so the object is decelerating. A and D are straight lines (constant speed); B has increasing gradient (accelerating).',
    criteria: [],
  },
  {
    id: 'igcse-diag-q20',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q50.webp',
      alt: 'Which quantity is equal to acceleration — graph interpretation',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Gradient or area? And of which graph?',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'D',
    solution: 'Acceleration = gradient of a speed–time graph. The gradient of a distance–time graph gives speed; the area under a speed–time graph gives distance.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q21',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q27.webp',
      alt: 'Speed–time graph with shaded area — which quantity equals the area under the graph',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Area under a speed–time graph = speed × time, which gives…?',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'Area under a speed–time graph = distance travelled. The gradient (not the area) gives acceleration.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q22',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.2/q54.webp',
      alt: 'Which statement about acceleration is correct',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Acceleration describes how speed changes — not distance or force directly.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'A',
    solution: 'Acceleration is related to the changing speed of an object (a = Δv/Δt). Option B describes speed; C and D confuse force with acceleration.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q23',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.5/q84.webp',
      alt: 'Object moves at constant speed around a circular path — which statement about the resultant force is correct',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'Constant speed does not mean zero acceleration — the direction is changing.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'C',
    solution: 'Even at constant speed, the velocity direction keeps changing, so the object accelerates. By Newton’s second law, a resultant force must act — towards the centre of the circle (centripetal force).',
    criteria: [],
  },
  {
    id: 'igcse-diag-q24',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.1/q42.webp',
      alt: 'Diagram of a micrometer screw gauge — the smallest reading that can be made',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'The thimble has 50 divisions; one full turn advances the spindle by 0.5 mm.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'B',
    solution: 'One turn of the thimble (50 divisions) moves the spindle 0.5 mm, so each division = 0.5 ÷ 50 = 0.01 mm. The smallest reading is 0.01 mm.',
    criteria: [],
  },
  {
    id: 'igcse-diag-q25',
    ...
    tags: [],
    image: {
      src: '/igcse-cie-all-assets/1.1/q37.webp',
      alt: 'Diagram of a micrometer screw gauge — for which measurement is it suitable',
      role: 'question',
    },
    maxScore: 1,
    source: SOURCE,
    answerNudge: 'A micrometer measures small lengths (0–25 mm) very precisely.',
    choices: [
      { label: 'A', text: '' },
      { label: 'B', text: '' },
      { label: 'C', text: '' },
    ...
    correctAnswer: 'D',
    solution: 'A micrometer screw gauge measures small dimensions (typically 0–25 mm) with 0.01 mm precision. The thickness of a copper sheet (~1.5 mm) fits its range; a 20 cm cylinder or 1 m rod is too large, and molecular distances are far too small.',
    criteria: [],
  },
];
...
export const igcseQuickDiagnosticMeta = {
  ...
  description:
    'A full diagnostic paper: 25 multiple-choice questions with a focus on motion graphs, core definitions of speed, velocity and acceleration, force and acceleration, and measurement techniques — with worked solutions for every question.',
